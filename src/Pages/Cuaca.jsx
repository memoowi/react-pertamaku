...
export default function Cuaca() {
  ...
  const fetchCuaca = async () => {
    const response = await fetch(
      "https://ibnux.github.io/BMKG-importer/cuaca/501219.json"
    );
  ...
  return (
    <div className="container mx-auto py-20">
      ...
      <div className="grid grid-cols-12 gap-8">
        {weather
          ? weather.map((cuaca) => (
              <div key={cuaca.jamCuaca} className="col-span-3 border-2 p-6 rounded-2xl border-gray-700 hover-card group">
                <h2>{formatDateTime(cuaca.jamCuaca)}</h2>
                <br />
                <img src={urlIcon + cuaca.kodeCuaca + ".png"} alt={cuaca.cuaca} className="mx-auto group-hover:animate-ping" />
                <br />
